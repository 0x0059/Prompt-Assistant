export default {
  ...
  nav: {
    home: 'Home',
    dashboard: 'Dashboard',
    promptAssistant: 'Moyu Prompt Assistant',
    modelManager: 'Model Manager',
    history: 'History',
    templates: 'Templates',
  },
  promptAssistant: {
    title: 'Moyu Prompt Assistant',
  ...
  test: {
    panel: 'Test Panel',
    showPanel: 'Show Test Panel',
    hidePanel: 'Hide Test Panel',
    ...
    optimizedResult: 'Assistant Prompt Result',
